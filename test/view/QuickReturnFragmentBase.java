...
public class QuickReturnFragmentBase extends Fragment implements ObservableScrollView.Callbacks {
    ...
    public QuickReturnFragmentBase() {
    }
        ...
        mObservableScrollView.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        Log.e("test placeholder", mObservableScrollView.getScrollY() + "~~~~");
                        mMaxScrollY = mObservableScrollView.computeVerticalScrollRange()
                                - mObservableScrollView.getHeight();
                        mQuickReturnHeight = mQuickReturnView.getHeight();
                        mHeight = mObservableScrollView.getHeight() + mQuickReturnHeight;
                    }
                });
    ...
    public void onScrollChanged(int scrollY) {
        ...
        Log.e("test placeholder", mPlaceholderView.getTop() + "~" + scrollY + "~" + mQuickReturnHeight + "~" + mObservableScrollView.getHeight());
        int translationY = 0;
